...
class Copy_manga_parser:
    ...
    def user_choose(self) -> dict:
        ...
        if user_input == "0" or user_input == "":
            ...
            if start > finish:
                raise "结束小于开始"
            down_chapters_infos = {
                k: v for k, v in list(self.all_chapter_name_id.items())[start:finish]
            }
    ...
    def main(self):
        ...
        if self.is_downloaded():
            ...
            copymanga_comic_downloader.Comic_downloader(
                self.comic_name, chapter_pic_comments
            ).main()
